<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Case Study -->
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#caseCollapse" aria-expanded="true" aria-controls="caseCollapse">
        <i class="fas fa-fw fa-folder"></i>
        <span>Case Study</span>
      </a>
      <div id="caseCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Case Study Options:</h6>
          <a class="collapse-item" href="{{route('post.index')}}">Case Study</a>
          <a class="collapse-item" href="{{route('post.create')}}">Add Case Study</a>
        </div>
      </div>
    </li>
